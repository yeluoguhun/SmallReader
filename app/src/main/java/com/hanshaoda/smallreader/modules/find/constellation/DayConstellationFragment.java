...
import com.hanshaoda.smallreader.widget.custom.MapTextView;
...
public class DayConstellationFragment extends BaseFragment {
    ...
    @BindView(R.id.radar_chat_day_star)
    RadarChart mChart;

    @BindView(R.id.summary_day_star)
    TextView mSummaryDayStar;
    @BindView(R.id.lucky_color_day_star)
    MapTextView mLuckyColor;
    @BindView(R.id.lucky_love_day_star)
    MapTextView mLuckyLove;
    @BindView(R.id.lucky_number_day_star)
...
//        mChart.setBackgroundColor(Color.rgb(60, 65, 82));
        ...
        // to use for it
        MarkerView mv = new RadarMarkerView(getContext(), R.layout.radar_markarview);
